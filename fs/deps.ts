...
export * as cxg from "https://denopkg.com/cfjello/cxgraph@v1.3/mod.ts";
export * as safety from "https://denopkg.com/shah/ts-safety@v1.0.0/mod.ts";
...
export * as extn from "../core/mod.ts";
